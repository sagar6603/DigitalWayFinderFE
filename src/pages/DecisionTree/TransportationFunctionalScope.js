...
import './TransportationFunctionalScope.css';
    ...
    <div className="functional-scope-container">
      <div className="breadcrumb">
        <div className="breadcrumb-content">
          ...
          <span>›</span>
          <span className="breadcrumb-current">Transportation Functional Scope</span>
        </div>
      </div>
      <div className="main-layout">
        <div className="left-sidebar">
          <h2 className="sidebar-title">Transportation Functional Scope</h2>
          <p className="sidebar-description">Select transportation functional requirements.</p>
        </div>
        <div className="main-content">
          <div className="content-header">
            <h1 className="page-title">Transportation Functional Scope</h1>
          </div>
