...
//       // Determine API endpoint and navigation route based on selected system
//       switch (selectedSystem) {
//         case 'Industry Agnostic':
//           apiEndpoint = 'api/decision-tree/functional-scope/ind-agnoustic/all';
//           navigationRoute = '/decision-tree/agnostic-functional-scope';
//           break;
//         case 'Retail Industry Specific':
//           apiEndpoint = 'api/decision-tree/functional-scope/retail/all';
//           navigationRoute = '/decision-tree/retail-functional-scope';
//           break;
//         case 'Consumer Goods Industry Specific':
//           apiEndpoint = 'api/decision-tree/functional-scope/cgs/all';
...
//       // Make API call to save industry type first
//       await apiPost('api/decision-tree/industry-type/supply-chain-planning/save', {
//         selectedSystem,
//         selectedArea: selectedFunctionalArea
//       });

//       // Then make the specific functional scope API call
